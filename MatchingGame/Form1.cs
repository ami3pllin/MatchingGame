...
namespace MatchingGame
{
        ...
        List<string> icons = new List<string>()
    {
        ...
        private void поменятьЦветМенюToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (colorDialog1.ShowDialog() == DialogResult.OK)
            {
        ...
        private void вернутьЦветToolStripMenuItem_Click(object sender, EventArgs e)
        {
